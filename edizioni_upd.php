...
.topnav a.active {
  ...
  <center>
	<center>
	<h1>Area Piscine</h1>
	<h3>Aggiornamento edizione</h3>
	</center>
</head>
<body>
		<form action="aggiornamento_edizioni.php" , method="POST">
    <center>
    	<table>
      <tr>
        <td>ID Corso:</td>
      ...
      <td><select name="numero">
            <?php
                    $conn = pg_connect("host=localhost port=5432 dbname=piscine user=postgres password=PostgresF28!");
                    $query = "SELECT DISTINCT numero FROM edizioni";
                    $result = pg_query($conn, $query);
  ...
  <td><input type="date" name="inizio"></td>
      ...
      <tr>
      <td></td><td><input class="left" type="submit" value="Aggiorna"><input class="right" type="reset" value="Annulla"></td>
      </tr>
    </table>
  </form>
	</center>
