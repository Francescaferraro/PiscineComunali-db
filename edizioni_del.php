...
.topnav a.active {
  ...
  color: white;
	...
	<center>
	<h1>Area Piscine</h1>
	<h3>Cancellazione edizione</h3>
	</center>
</head>
<body>
	
		<form action="cancellazione_edizioni.php" , method="POST">
    <center>
    	<table>
      <tr>
        <td>Corso:</td>
        <td>
            ...
            <?php
                    ...
                    $query = "SELECT corso FROM edizioni";
                    ...
                    if (!$result) {
                        ...
                        while ($row = pg_fetch_array($result)) {
                            echo ' <option value= "' . $row['corso'] . '" >' . $row['corso'] . '</option>';
                        };
                    };
                    ?> 
          </select>
